...
public class SchoolControllerTest {
    ...
    public void testGetSchoolsByParams() {
        ...
        school.setMinCode("1234567");
        school.setSchoolName("Test School");
        Mockito.when(schoolService.getSchoolsByParams("1234567", "123", "accessToken")).thenReturn(Arrays.asList(school));
        schoolController.getSchoolsByParams("1234567", "123", "accessToken");
        Mockito.verify(schoolService).getSchoolsByParams("1234567", "123", "accessToken");
    }
