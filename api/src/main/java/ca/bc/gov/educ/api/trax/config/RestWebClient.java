...
public class RestWebClient {
    ...
    @Autowired
    public RestWebClient(EducGradTraxApiConstants constants) {
        this.constants = constants;
        this.httpClient = HttpClient.create(ConnectionProvider.create("trax-api")).compress(true)
    ...
    public WebClient getCourseApiClientWebClient(OAuth2AuthorizedClientManager authorizedClientManager) {
        ...
        filter.setDefaultClientRegistrationId("trax-api-client");
