...
public class BusinessException extends Exception {
  ...
  @Getter
  private final ca.bc.gov.educ.api.trax.exception.BusinessError businessError;

  public BusinessException(ca.bc.gov.educ.api.trax.exception.BusinessError businessError, String... messageArgs) {
